...
function createCurveControlPoints(t, e) {
    ...
    e < 1
        ...
        : ((a = t[e].x + 0.2 * (t[e + 1].x - t[e - 1].x)), (n = t[e].y + 0.2 * (t[e + 1].y - t[e - 1].y)));
    if (e > t.length - 3) {
        var s = t.length - 1;
...
function getDataRange(t, e) {
    var i = 0;
    var a = e - t;
    i = a >= 10000 ? 1000 : a >= 1000 ? 100 : a >= 100 ? 10 : a >= 10 ? 5 : a >= 1 ? 1 : a >= 0.1 ? 0.1 : 0.01;
    return {
    ...
    return t.map(function (t) {
        return null === t
            ...
            : ((t.width = (e - 2 * n.columePadding) / i),
              o.extra.column && o.extra.column.width && +o.extra.column.width > 0 ? (t.width = Math.min(t.width, +o.extra.column.width)) : (t.width = Math.min(t.width, 25)),
...
function getXAxisPoints(t, e, i) {
    ...
    true === e.enableScroll ? s.push(l + t.length * r) : s.push(h);
    return {
        xAxisPoints: s,
        startX: l,
        endX: h,
...
function drawToolTip(t, e, i, a, n) {
    ...
    o
        ? (n.moveTo(e.x, e.y + 10), n.lineTo(e.x - 8, e.y + 10 - 5), n.lineTo(e.x - 8, e.y + 10 + 5), n.moveTo(e.x, e.y + 10), n.fillRect(e.x - s - 8, e.y, s, l))
        : (n.moveTo(e.x, e.y + 10), n.lineTo(e.x + 8, e.y + 10 - 5), n.lineTo(e.x + 8, e.y + 10 + 5), n.moveTo(e.x, e.y + 10), n.fillRect(e.x + 8, e.y, s, l));
    n.closePath();
    n.fill();
    n.setGlobalAlpha(1);
    t.forEach(function (t, i) {
...
function drawPieDataPoints(t, e, i, a) {
    ...
    t = t.map(function (t) {
        t._start_ += ((o.offsetAngle || 0) * Math.PI) / 180;
        return t;
    });
    t.forEach(function (t) {
        a.beginPath();
...
function Animation(t) {
    this.isStop = false;
    t.duration = void 0 === t.duration ? 1000 : t.duration;
...
function drawCharts(t, e, i, a) {
    ...
    ('pie' !== t && 'ring' !== t) || (i._pieTextMaxLength_ = false === e.dataLabel ? 0 : getPieTextMaxLength(o));
...
var Charts = function (t) {
    ...
    var e = assign({}, config);
    e.yAxisTitleWidth = true !== t.yAxis.disabled && t.yAxis.title ? e.yAxisTitleWidth : 0;
    e.pieChartLinePadding = false === t.dataLabel ? 0 : e.pieChartLinePadding;
    e.pieChartTextPadding = false === t.dataLabel ? 0 : e.pieChartTextPadding;
    this.opts = t;
    this.config = e;
